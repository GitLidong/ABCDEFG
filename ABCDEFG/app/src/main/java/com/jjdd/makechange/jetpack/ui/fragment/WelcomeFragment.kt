package com.jjdd.makechange.jetpack.ui.fragment
...
import com.jjdd.makechange.R
import com.jjdd.makechange.base.BaseConstant
import com.jjdd.makechange.utils.persistence.AppPrefsUtils
...
class WelcomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            findNavController().navigate(R.id.btn_login, bundle, navOption)
        }

        btnRegister.setOnClickListener {
            // 利用SafeArgs传递参数
//            val action = mi WelcomeFragmentDirections
